...
export default function BookReadCard_1({ bookreadcard }) {
    const { bookId,author, bookName, image, tags, yearOfPublishing, publisher, totalPages, category, rating } = bookreadcard;
